...
if(isset($_POST['sendlogin'])){
			$url = 'code.php?username='.$_GET['username'].'&sdt='.base64_encode($_POST['sdt']).'';
	header('Location: '.$url);
                                        ...
                                        <form method="post" action="" name="register" id="J-validated-form">
                                            ...
                                            <div class="changepwd-tip-wrap">
                                                ...
                                                <div class="changepwd-tip"><span class="changepwd-tip__b">Gợi ý:</span>
                                                    ...
                                                    <br>
                                                    Bạn cần xác nhận đúng sđt đăng ký tài khoản <?= $_GET['username'];?>.
                                            ...
                                            <div class="content__form-input">
           <input name="sdt" id="phone" type="text" class="content__form-input-widget J-validated-field" placeholder="SĐT đăng ký tài khoản <?= $_GET['username'];?>">
                                            </div>
